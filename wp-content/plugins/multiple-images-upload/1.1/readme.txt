...
5. In Multiple Image Post settings now you can add multiple custom post types by entering comma seperated values i.e pages, post, post_type1, post_type2 etc, etc
...
* Add multiple custom post types option.
