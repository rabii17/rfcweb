...
/* Template Name: List of refrences */
					...
					foreach ($refrences as $refrence):			
						...
						<li class="col-lg-4 col-sm-6 col-xs-12">
							...
							<figure>
								...
								<a href="<?php echo get_the_excerpt($refrence->ID); ?>" target="_blank">
								...
								<figcaption>
									...
									<p>
										...
										<a href="<?php echo get_the_excerpt($refrence->ID); ?>" target="_blank"><?php echo get_the_excerpt($refrence->ID); ?></a>
