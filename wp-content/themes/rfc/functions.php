...
function add_theme_scripts() {
    ...
    wp_enqueue_script('googleapis', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBl6im-GDKBPABj6jyumsdKWRw2Hx4Z6SA&callback=initMap', array(), null, true);

    wp_enqueue_script('map', get_template_directory_uri() . '/js/map.js', array(), null, true);

    wp_enqueue_script('recaptcha', 'https://www.google.com/recaptcha/api.js?render=6LdyrIQUAAAAAI0kxIJQ4jn8q9QmgOhU-HjbZydX', array(), null, true);
...
document.addEventListener( 'wpcf7mailsent', function( event ) {
   if ( '39' == event.detail.contactFormId ) { // Sends sumissions on form 947 to the first thank you page
    location = 'https://www.rfc.com.tn/merci-contact/';
    } 
}, false );
</script>
<?php
