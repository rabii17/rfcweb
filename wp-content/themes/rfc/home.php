	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12 head-padd text-left" >
				<h2 class="" style="color:#fff"><?php //echo get_post_meta(get_the_ID(), 'page_header_title', true) ?></h2>
				<p class="desc">
...
<section class="training">
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <h3 class="titles">NOS FORMATIONS <span class="tiret blue-bg center-block"></span></h3>
                </div>
            </div>
            <div class="row">
                <?php
                ...
                <div class="col-xs-12 text-center">
                    <a class="see-all red-bg" href="https://www.pi2r-experience.com/rfc_v2/formations/">Voir toutes nos formations</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="debutant-experimentes">
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <h3 class="titles" style="color:#fff !important;">DÉBUTANTS OU EXPÉRIMENTÉS
 <span class="tiret blue-bg center-block"></span></h3>
 <h4 style="font-size:25px;font-weight:400;color: rgb( 55, 63, 72 ); text-transform:none;color:#fff !important;">RFC vous offre un environnement de travail incubateur qui favorise la concrétisation de vos<br /> connaissances avec l’aide de nos experts consultants<br><br></h4>
                </div>
                <div class="col-xs-12 text-center">
                    <!--.Carousel-->

                    <a class="see-all blue-bg" href="https://www.pi2r-experience.com/rfc_v2/carriere/">voir toutes nos offres</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="news">
								...
								<div class="item <?php echo $class ?>">  
									<div class="row">
										<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-right">
											<img src="<?php echo get_the_post_thumbnail_url($new->ID, "full") ?>" style="border:10px solid #b4bbcb;" alt="<?php echo $new->post_title; ?>" class="img-responsive">
										</div>
    ...
    <div class="contact">
        ...
        <div class="row">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12771.56880401697!2d10.1835574!3d36.8450577!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x9bba35cfe3f4f394!2sRFC+-+Int%C3%A9grateur+d&#39;infrastructure+IT%2C+Formation+%26+CLOUD+en+Tunisie!5e0!3m2!1sfr!2stn!4v1546602696823" width="100%" height="500" frameborder="0" style="border:0" allowfullscreen></iframe>
