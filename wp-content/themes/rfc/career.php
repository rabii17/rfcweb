...
<section class="">
    <div class="container-fluid">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <img src="/wp-content/uploads/2017/07/car_1.jpg" class="img-responsive" style="height:252px;">
                    <div><a class="profils" style="font-size:15px;padding: 38px 19px;">Des perspectives d'évolution</a></div>
                </div>
                <div class="col-md-4">
                    <img src="/wp-content/uploads/2017/07/car_2.jpg" class="img-responsive"  style="height:252px;">
                    <div><a class="profils" style="font-size:15px">Une formation métier professionnelle et intéressante</a></div>
                </div>
                <div class="col-md-4">
                    <img src="/wp-content/uploads/2017/07/car_3.jpg" class="img-responsive"  style="height:252px;">
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
				<div class="col-lg-12 text-center">
					<div class="intro-text">
						<h3 class="titles"><?php echo get_post_meta(get_the_ID(), 'page_header_title_2', true) ?> <span class="tiret blue-bg center-block"></span></h3>
